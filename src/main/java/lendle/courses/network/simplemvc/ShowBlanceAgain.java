 ...
 * @author user
 */
@WebServlet(name = "ShowBlanceAgain", urlPatterns = {"/ShowBlanceAgain"})
public class ShowBlanceAgain extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (bankCustomer == null) {
             ...
             rd.forward(request, response); //內轉址
             //response.sendRedirect("bank-account/NegativeBalance.jsp"); //外轉址
